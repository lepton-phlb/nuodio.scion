========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet dev-bsp-nu.tube
========================================================================

AppWizard a créé ce projet de bibliothèque dev-bsp-nu.tube à votre intention.

Aucun fichier source n'a été créé dans le cadre de votre projet.


dev-bsp-nu.tube.vcxproj
...
dev-bsp-nu.tube.vcxproj.filters
