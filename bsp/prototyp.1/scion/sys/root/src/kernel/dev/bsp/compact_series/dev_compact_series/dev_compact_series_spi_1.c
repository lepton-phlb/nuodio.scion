...
Global Declaration
=============================================*/
const char dev_compact_series_spi_1_name[]="spi1\0";

int dev_compact_series_spi_1_load(void);
int dev_compact_series_spi_1_open(desc_t desc, int o_flag);
...
dev_map_t dev_compact_series_spi_1_map={
   dev_compact_series_spi_1_name,
   S_IFCHR,
   dev_compact_series_spi_1_load,
   dev_compact_series_spi_1_open,
...
extern board_stm32f4xx_spi_info_t compact_series_spi_1;
...
/*-------------------------------------------
| Name:dev_compact_series_spi_1_load
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_compact_series_spi_1_load(void) {
   
   compact_series_spi_1.spi_descriptor.board_spi_info=&compact_series_spi_1;
   compact_series_spi_1.desc_r=-1;
   compact_series_spi_1.desc_w=-1;
   
   //__HAL_RCC_SPI5_CLK_ENABLE();
   
   return dev_stm32f4xx_spi_x_load(&compact_series_spi_1);
}
   
/*-------------------------------------------
| Name:dev_compact_series_spi_1_open
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_compact_series_spi_1_open(desc_t desc, int o_flag) {
   return dev_stm32f4xx_spi_x_open(desc, o_flag, &compact_series_spi_1);
}

/*============================================
| End of Source  : dev_compact_series_spi_1.c
==============================================*/
