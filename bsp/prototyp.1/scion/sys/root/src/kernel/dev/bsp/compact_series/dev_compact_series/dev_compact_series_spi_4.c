...
Global Declaration
=============================================*/
const char dev_compact_series_spi_4_name[]="spi4\0";

int dev_compact_series_spi_4_load(void);
int dev_compact_series_spi_4_open(desc_t desc, int o_flag);
...
dev_map_t dev_compact_series_spi_4_map={
   dev_compact_series_spi_4_name,
   S_IFCHR,
   dev_compact_series_spi_4_load,
   dev_compact_series_spi_4_open,
...
extern board_stm32f4xx_spi_info_t compact_series_spi_4;
...
/*-------------------------------------------
| Name:dev_compact_series_spi_4_load
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_compact_series_spi_4_load(void) {
   
   compact_series_spi_4.spi_descriptor.board_spi_info=&compact_series_spi_4;
   compact_series_spi_4.desc_r=-1;
   compact_series_spi_4.desc_w=-1;
   //
   return dev_stm32f4xx_spi_x_load(&compact_series_spi_4);
}
   
/*-------------------------------------------
| Name:dev_compact_series_spi_4_open
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_compact_series_spi_4_open(desc_t desc, int o_flag) {
   return dev_stm32f4xx_spi_x_open(desc, o_flag, &compact_series_spi_4);
}

/*============================================
| End of Source  : dev_compact_series_spi_4.c
==============================================*/
