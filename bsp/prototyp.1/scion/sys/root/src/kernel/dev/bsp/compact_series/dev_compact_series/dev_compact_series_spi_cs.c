...
#include "dev_compact_series_spi_cs.h"
...
const char dev_compact_series_spi_cs_name[]="spics\0compact_series_spi_cs\0";

int dev_compact_series_spi_cs_load(void);
int dev_compact_series_spi_cs_open(desc_t desc, int o_flag);
int dev_compact_series_spi_cs_close(desc_t desc);
int dev_compact_series_spi_cs_isset_read(desc_t desc);
int dev_compact_series_spi_cs_isset_write(desc_t desc);
int dev_compact_series_spi_cs_read(desc_t desc, char* buf,int size);
int dev_compact_series_spi_cs_write(desc_t desc, const char* buf,int size);
int dev_compact_series_spi_cs_seek(desc_t desc,int offset,int origin);
int dev_compact_series_spi_cs_ioctl(desc_t desc,int request,va_list ap);

dev_map_t dev_compact_series_spi_cs_map={
   dev_compact_series_spi_cs_name,
   S_IFBLK,
   dev_compact_series_spi_cs_load,
   dev_compact_series_spi_cs_open,
   dev_compact_series_spi_cs_close,
   __fdev_not_implemented,
   __fdev_not_implemented,
   dev_compact_series_spi_cs_read,
   dev_compact_series_spi_cs_write,
   dev_compact_series_spi_cs_seek,
   dev_compact_series_spi_cs_ioctl //ioctl
};
...
/*-------------------------------------------
| Name:dev_compact_series_spi_cs_load
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_compact_series_spi_cs_open
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_compact_series_spi_cs_close
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_compact_series_spi_cs_isset_read
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_compact_series_spi_cs_isset_write
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_compact_series_spi_cs_read
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_compact_series_spi_cs_write
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_compact_series_spi_cs_seek
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*-------------------------------------------
| Name:dev_compact_series_spi_cs_ioctl
| Description:
| Parameters:
| Return Type:
| Comments:
...
/*============================================
| End of Source  : dev_compact_series_spi_cs.c
==============================================*/
