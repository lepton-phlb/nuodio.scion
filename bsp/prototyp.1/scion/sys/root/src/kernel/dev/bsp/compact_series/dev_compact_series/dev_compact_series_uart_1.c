...
Global Declaration
=============================================*/
const char dev_compact_series_uart_s1_name[]="ttys1\0";

int dev_compact_series_uart_s1_load(void);
int dev_compact_series_uart_s1_open(desc_t desc, int o_flag);
...
dev_map_t dev_compact_series_uart_s1_map={
   dev_compact_series_uart_s1_name,
   S_IFCHR,
   dev_compact_series_uart_s1_load,
   dev_compact_series_uart_s1_open,
...
// uart 1 configuration. see in board device driver of current bsp
extern board_stm32f4xx_uart_info_t stm32f4xx_uart_1; 
...
{
  uart_irq_handler(&stm32f4xx_uart_1.uart_descriptor);
}

void DMA2_Stream5_IRQHandler(void)
{
  uart_dma_irq_handler(&stm32f4xx_uart_1.uart_descriptor);
}

/*-------------------------------------------
| Name:dev_stm32f4xx_uart_1_load
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_compact_series_uart_s1_load(void) {
   
   stm32f4xx_uart_1.uart_descriptor.board_uart_info=&stm32f4xx_uart_1;
   stm32f4xx_uart_1.desc_r=-1;
   stm32f4xx_uart_1.desc_w=-1;
   
   stm32f4xx_uart_1.baudrate= 31250;
   
   return dev_stm32f4xx_uart_x_load(&stm32f4xx_uart_1);
}
   
/*-------------------------------------------
| Name:dev_stm32f4xx_uart_1_open
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_compact_series_uart_s1_open(desc_t desc, int o_flag) {
   return dev_stm32f4xx_uart_x_open(desc, o_flag, &stm32f4xx_uart_1);
}
