...
Global Declaration
=============================================*/
const char dev_compact_series_uart_s3_name[]="ttys3\0";

int dev_compact_series_uart_s3_load(void);
int dev_compact_series_uart_s3_open(desc_t desc, int o_flag);
...
dev_map_t dev_compact_series_uart_s3_map={
   dev_compact_series_uart_s3_name,
   S_IFCHR,
   dev_compact_series_uart_s3_load,
   dev_compact_series_uart_s3_open,
...
extern board_stm32f4xx_uart_info_t stm32f4xx_uart_3; 
...
| See:
---------------------------------------------*/
static int dev_compact_series_uart_s3_load(void) {
...
| See:
---------------------------------------------*/
static int dev_compact_series_uart_s3_open(desc_t desc, int o_flag) {
