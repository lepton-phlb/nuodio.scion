...
Global Declaration
=============================================*/
const char dev_hybrid_tube_spi_1_name[]="spi1\0";

int dev_hybrid_tube_spi_1_load(void);
int dev_hybrid_tube_spi_1_open(desc_t desc, int o_flag);
...
dev_map_t dev_hybrid_tube_spi_1_map={
   dev_hybrid_tube_spi_1_name,
   S_IFCHR,
   dev_hybrid_tube_spi_1_load,
   dev_hybrid_tube_spi_1_open,
...
extern board_stm32f4xx_spi_info_t hybrid_tube_spi_1;
...
/*-------------------------------------------
| Name:dev_hybrid_tube_spi_1_load
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_hybrid_tube_spi_1_load(void) {
   
   hybrid_tube_spi_1.spi_descriptor.board_spi_info=&hybrid_tube_spi_1;
   hybrid_tube_spi_1.desc_r=-1;
   hybrid_tube_spi_1.desc_w=-1;
   
   //__HAL_RCC_SPI5_CLK_ENABLE();
   
   return dev_stm32f4xx_spi_x_load(&hybrid_tube_spi_1);
}
   
/*-------------------------------------------
| Name:dev_hybrid_tube_spi_1_open
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_hybrid_tube_spi_1_open(desc_t desc, int o_flag) {
   return dev_stm32f4xx_spi_x_open(desc, o_flag, &hybrid_tube_spi_1);
}

/*============================================
| End of Source  : dev_hybrid_tube_spi_1.c
==============================================*/
