...
Global Declaration
=============================================*/
const char dev_hybrid_tube_uart_3_name[]="ttys3\0";

int dev_hybrid_tube_uart_3_load(void);
int dev_hybrid_tube_uart_3_open(desc_t desc, int o_flag);
...
dev_map_t dev_hybrid_tube_uart_s3_map={
   dev_hybrid_tube_uart_3_name,
   S_IFCHR,
   dev_hybrid_tube_uart_3_load,
   dev_hybrid_tube_uart_3_open,
...
| See:
---------------------------------------------*/
static int dev_hybrid_tube_uart_3_open(desc_t desc, int o_flag) {
