...
extern rotary_encoder_info_t rotary_encoder_info_3;

const char dev_rotary_encoder_3_name[]="rotry3\0rotary_encoder_3\0";

static int dev_rotary_encoder_3_load(void);
static int dev_rotary_encoder_3_open(desc_t desc, int o_flag);

dev_map_t dev_rotary_encoder_3_map={
   dev_rotary_encoder_3_name,
   S_IFCHR,
   dev_rotary_encoder_3_load,
   dev_rotary_encoder_3_open,
...
/*-------------------------------------------
| Name:dev_rotary_encoder_3_load
| Description:
| Parameters:
| Return Type:
| Comments:
...
---------------------------------------------*/
static int dev_rotary_encoder_3_load(void){
  dev_rotary_encoder_x_load(&rotary_encoder_info_3);
  return 0;
}

/*-------------------------------------------
| Name:dev_rotary_encoder_3_open
| Description:
| Parameters:
| Return Type:
| Comments:
...
---------------------------------------------*/
static int dev_rotary_encoder_3_open(desc_t desc, int o_flag){
   dev_rotary_encoder_x_open(desc,o_flag, &rotary_encoder_info_3);
   return 0;
}
